...
func Test_plusOne(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "1", args: args{seq: "0000", index: 0}, want: "1000"},
		{name: "2", args: args{seq: "8000", index: 0}, want: "9000"},
		{name: "3", args: args{seq: "9000", index: 0}, want: "0000"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := plusOne(tt.args.seq, tt.args.index); got != tt.want {
...
func Test_minusOne(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "1", args: args{seq: "0000", index: 0}, want: "9000"},
		{name: "2", args: args{seq: "8000", index: 0}, want: "7000"},
		{name: "3", args: args{seq: "0000", index: 3}, want: "0009"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := minusOne(tt.args.seq, tt.args.index); got != tt.want {
				t.Errorf("minusOne() = %v, want %v", got, tt.want)
			}
		})
	}
}
